import 'dart:convert';
import 'dart:io';
import 'package:amaxonclone/constants/error_handling.dart';
import 'package:amaxonclone/constants/utils.dart';
import 'package:amaxonclone/models/product.dart';
...
class AdminService {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('dcynsqnyq', 'yp8xvygc');
